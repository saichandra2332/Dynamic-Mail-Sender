...
if (isset($_POST['sub'])) {
    $loginid1 = $_POST['lid'];
    $pwd2 = $_POST['password'];
    $Getdetails = mysqli_query($conn, "SELECT * FROM login WHERE user_mail='$loginid1' AND user_pwd='$pwd2' AND user_status='1'") or die(mysqli_error($conn));
...
?>
    ...
    <center><h2>Login</h2></center>
        ...
        <center><button type="submit" onclick="validateForm()" name="sub" id="sub">Login</button></center>
    </form>
